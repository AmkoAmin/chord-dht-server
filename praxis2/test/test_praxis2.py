...
task_1_2_passed = False
@pytest.mark.timeout(10)
def test_immediate_dht(static_peer):
    ...
    for uri in uris:
        ...
        time.sleep(0.01) # add some delay between calls

    global task_1_2_passed
    task_1_2_passed = True

@pytest.mark.timeout(1)
def test_task_1_2_passed():
    assert task_1_2_passed, "Task 1.2 not passed"


task_1_3_passed = False
@pytest.mark.timeout(3)
def test_lookup_sent(static_peer):
    ...
    global task_1_3_passed
    task_1_3_passed = True

@pytest.mark.timeout(1)
def test_task_1_3_passed():
    assert task_1_3_passed, "Task 1.3 not passed"
...
task_1_6_passed = False
@pytest.mark.timeout(6)
def test_lookup_complete(static_peer):
    ...
    global task_1_6_passed
    task_1_6_passed = True

@pytest.mark.timeout(1)
def test_task_1_6_passed():
    assert task_1_6_passed, "Task 1.6 not passed"
